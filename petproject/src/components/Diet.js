...
async function diet_decide(animal, breed) {
    ...
    const completion = await openai.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "user",
                content: "You are a dietician for pets, recommend a personalised diet chart, the animal is " + animal + " and the breed is " + breed,
            },
        ],
        store: true,
    });
